...
test_that("get_queryId_results() returns an NA_integer_ vector if query ID is wrong", {
  expect_equal(suppressWarnings(get_queryId_results(queryId = "A wrong query ID",
                                                    status = "Complete",
...
test_that("get_queryId_results() returns an NA_integer_ vector if apikey is wrong", {
  expect_equal(suppressWarnings(get_queryId_results(queryId = "abcdefgh-abcd-abcd-abcd-abcdefghijkl", 
                                                    status = "Complete",
