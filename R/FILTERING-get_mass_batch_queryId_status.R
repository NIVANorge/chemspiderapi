...
#' 
#' @param queryId A valid 36-character ChemSpider query ID obtained from \code{post_mass_batch()}.
...
#' @export
get_mass_batch_queryId_status <- function(queryId, count = TRUE, message = TRUE, apikey, coerce = FALSE, simplify = FALSE) {
