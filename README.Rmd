...
As of `r Sys.Date()`, the following functionalities are implemented (`r (25 / 25) * 100`% of functionality with `r round((18 / 27) * 100, digits = 0)`% annotation):
...
|filter-queryId-results-sdf-get|`chemspideR::get_sdf()` <span style="color:red">**\***</span>||
