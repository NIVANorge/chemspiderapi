...
As of `r Sys.Date()`, the following functionalities are implemented (`r (25 / 25) * 100`% functionality with `r round((18 / 27) * 100, digits = 0)`% overall annotation and `r round((10 / 27) * 100, digits = 0)`% quality annotation):
