...
<!-- badges: start -->
[![AppVeyor build status](https://ci.appveyor.com/api/projects/status/github/NIVANorge/chemspiderapi?branch=master&svg=true)](https://ci.appveyor.com/project/skrytebane/chemspiderapi)
