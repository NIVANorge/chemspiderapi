...
As of `r Sys.Date()`, the following functionalities are implemented (`r signif((25 / 25) * 100, digits = 2)`% functionality with `r signif((18 / 27) * 100, digits = 2)`% overall annotation and `r signif((15 / 27) * 100, digits = 2)`% quality annotation):
